...
if(isset($_SESSION['userLoggedIn'])){
    $favourite_endpoint = $base_url . "user/getUser/getFavouriteAlbumsByUserID.php?user_id=$logged_in_user_id";
    $favourite_resource = @file_get_contents($favourite_endpoint);
    $favourite_data = json_decode($favourite_resource, true);

    $owned_endpoint = $base_url . "user/getUser/getOwnedAlbumsByUserID.php?user_id=$logged_in_user_id";
