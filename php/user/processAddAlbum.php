    ...
    if($existing_album){
        ...
        foreach($artist_data as $current_artist){
            if($current_artist[0] == $artist){
                ...
                $get_artist_endpoint = $base_url . "album/getArtistIDByName.php?artist_name=$artist";
        ...
        if(!$existing_artist){
            //create new artist
            $create_artist_endpoint = $base_url . "album/createArtist.php?artist_name=$artist";
        ...
        if(!$existing_year){
            //create new year
            $create_year_endpoint = $base_url . "album/createYear.php?year_value=$year";
        ...
        //create art
        $create_art_endpoint = $base_url . "album/createArt.php?art_url=$art_url";
        ...
        //create album
        $create_album_endpoint = $base_url . "album/createAlbum.php?title=$title&art_id=$art_id&artist_id=$artist_id&year_id=$year_id&spotify_id=$spotify_id&album_rating=$rating";
